...
class MLFallbackPredictor:
    ...
    def prepare_input(
        ...
        row = {
            ...
            "predicted_sub_subcategory": self._clean_text(predicted_sub_subcategory),
    ...
    def predict(
        ...
        X = self.prepare_input(
            ...
            predicted_sub_subcategory=predicted_sub_subcategory,
            city=city,
            country=country,
            amount=amount,
...
if __name__ == "__main__":
    ...
    result = predictor.predict(
        ...
        predicted_sub_subcategory="family clothing stores",
        city="beirut",
        country="lebanon",
        amount=120.0,
        transaction_month="3",
